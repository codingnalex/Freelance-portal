            ...
            <div class="container">
                <div class="author-<?php echo $class_name ?>-wrap">
					...
					<?php if ( fre_share_role() || ae_user_role( $author_id ) == FREELANCER ) { ?>
						...
						$file_video = get_user_meta( $author_id, 'file_video', true );
						...
						<div class="fre-profile-box" id="blockMyVideo">
							...
							<div class="video_present">
								...
								<div class="col-lg-5 col-md-12 vidoe_info">
									<h3 class="freelance-portfolio-title"><?php _e( 'FILE DETAILS', ET_DOMAIN ); ?></h3>
									<?php
									$title_video = get_user_meta( $author_id, 'title_video', true );
									$desc_video = get_user_meta( $author_id, 'desc_video', true );
									?>
									<div>
										<span><?php _e( 'Title', ET_DOMAIN ); ?></span><span><?php if($title_video) { echo $title_video; } else { echo ''; } ?></span>
									</div>
									<div>
										<span><?php _e( 'Description', ET_DOMAIN ); ?></span><span><?php if($desc_video) { echo $desc_video; } else { echo ''; }  ?></span>
									</div>
									<div>
										<span><?php _e( 'Duration', ET_DOMAIN ); ?></span><span><?php if($file_video) { echo $attachment_meta['length_formatted']; } else { echo ''; }  ?></span>
									</div>
									<div>
										<span><?php _e( 'Date uploaded', ET_DOMAIN ); ?></span><span><?php if($file_video) { echo $date; } else { echo ''; }  ?></span>
									</div>
								</div>
							</div>
						</div>
