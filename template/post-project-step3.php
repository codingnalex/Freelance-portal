				...
				<div class="step1 step_custom active_step">
					...
					<div class="content_step">
						...
						<div class="group_radio_btn">
							<fieldset id="et_groupwork">
								<div class="block_radio fre-project-groupwork" data-radio="les">
									<p><?php _e('Short-term or part-time work', ET_DOMAIN);?></p>
									<span><?php _e('Less than 40 hrs/week Less than 3 months', ET_DOMAIN);?></span>
									<input type="radio" class="les" value="les" name="et_groupwork">
								</div>
								<div class="block_radio fre-project-groupwork" data-radio="more">
									<p><?php _e('Dedicated, long term work', ET_DOMAIN);?></p>
									<span><?php _e('More than 40 hrs/week 3+ months', ET_DOMAIN);?></span>
									<input type="radio" class="more" value="more" name="et_groupwork">
								</div>
						...
						<div class="group_radio_btn">
							<fieldset id="et_group_see_job">
								<div class="block_radio" data-radio="freelancers">
									...
									<input type="radio" class="freelancers" value="freelancers" name="et_group_see_job">
								</div>
								<div class="block_radio" data-radio="virtual">
									...
									<input type="radio" class="virtual" value="virtual" name="et_group_see_job">
								</div>
								<div class="block_radio" data-radio="invited">
									...
									<input type="radio" class="invited" value="invited" name="et_group_see_job">
								</div>
					...
					<div class="content_step">
						<div class="fre-input-field">
							...
							<div class="limit_hours">
								<p class="active_limit_p"><input type="checkbox" id="active_limit"><?php _e('Limit hours logged to', ET_DOMAIN);?></p>
								<p class="hours_limit_p fre-project-hourslimit"><input type="text" id="hours_limit" class="input-item text-field is_number numberVal" name="et_activelimit" disabled><?php _e('hrs/week', ET_DOMAIN);?></p>
				...
				<div class="step7 step_custom" style="display: none">
					...
					<div class="content_step">
						<div class="block_step1_info block_step_info">
							<span class="back_to_edit_1 back_to_edit"></span>
							<h2><?php _e('Title', ET_DOMAIN);?></h2>
						...
						<div class="block_step2_info block_step_info">
							<span class="back_to_edit_2 back_to_edit"></span>
							<h2><?php _e('Description', ET_DOMAIN);?></h2>
						...
						<div class="block_step5_info block_step_info">
							<span class="back_to_edit_5 back_to_edit"></span>
							<h2><?php _e('BUDGET', ET_DOMAIN);?></h2>
